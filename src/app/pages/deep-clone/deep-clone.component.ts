...
@Component({
  selector: 'app-deep-clone',
  templateUrl: './deep-clone.component.html',
  styleUrls: ['./deep-clone.component.scss'],
})
export class DeepCloneComponent implements OnInit {
  code = `export function DeepCopy(item: any) {
